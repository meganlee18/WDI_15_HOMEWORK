...
//have properties for title (a string), servings (a number), and 
...
//Now use an if/else 
//statement to change the output depending on whether you read it yet or 
//not. If you read it, log a string like 'You already read "The Hobbit" by 
...
console.log(bookTwo.title + ' by ' + bookTwo.author);


if (bookTwo.alreadyRead === false) {
	console.log ('You still need to read ' + bookTwo.title + ' by ' + bookTwo.author) 
	}else{
	console.log ('You already read ' +  bookTwo.title + ' by ' + bookTwo.author)
}

if (bookOne.alreadyRead === false) {
	console.log ('You still need to read ' + bookOne.title + ' by ' + bookOne.author) 
	}else{
	console.log ('You already read ' +  bookOne.title + ' by ' + bookOne.author)
}
...
var favouriteMovie = {
	...
	duration: 110,
	stars: ['Tommy Lee Jones', ' Leonardo Dicaprio ', ' Jamie Foxx']
